...
private:
    ...
    // Precomputing preconditioner
    int precomputeJacobiPreconditioner(cl::Buffer& X,
    ...
    std::shared_ptr<cl::make_kernel<cl::Buffer&, cl::Buffer&>> FLOAT_multiply_vectors_into_first_vector;
    std::shared_ptr<cl::make_kernel<cl::Buffer&>> FLOAT_compute_sqrt;
    std::shared_ptr<cl::make_kernel<cl::Buffer&>> FLOAT_compute_inverse;
