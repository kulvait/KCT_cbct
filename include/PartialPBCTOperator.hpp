 ...
 * The main difference between PartialPBCTOperator and BasePBCTOperator is that PartialPBCTOperator
 * will not erase destination array before projection or backprojection. So it behaves additivelly.
 */
class PartialPBCTOperator : public virtual Kniha, public AlgorithmsBarrierBuffers
{
public:
