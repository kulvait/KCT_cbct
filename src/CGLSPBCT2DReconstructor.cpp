...
void CGLSPBCT2DReconstructor::removeTikhonovRegularization() { this->tikhonovRegularization = false; }
...
int CGLSPBCT2DReconstructor::reconstructTikhonov(uint32_t maxIterations, float errCondition)
{
    std::string INFO;
