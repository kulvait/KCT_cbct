 ...
 * @return
 */
int BasePBCTReconstructor::initializeVectors(float* projections,
                                             float* volume,
...
void BasePBCTReconstructor::writeVolume(cl::Buffer& X, std::string path)
{
...
void BasePBCTReconstructor::writeProjections(cl::Buffer& B, std::string path)
{
...
void BasePBCTReconstructor::setReportingParameters(bool verbose,
...
double BasePBCTReconstructor::adjointProductTest()
{
