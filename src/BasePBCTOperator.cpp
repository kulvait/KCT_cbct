                                       ...
                                       cl::NDRange backprojectorLocalNDRange)
{
    ...
    if(val == 0)
    {
        PBCTLocalNDRangeFactory localRangeFactory(vdimx, vdimy, vdimz, maxWorkGroupSize);
        bool verbose = true;
...
void BasePBCTOperator::initializeSiddonProjector(uint32_t probesPerEdgeX, uint32_t probesPerEdgeY)
{
    if(!isOpenCLInitialized())
    {
