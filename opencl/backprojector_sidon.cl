void kernel FLOATsidon_backproject(global float* volume,
                                   ...
                                   private uint2 raysPerPixel)
{
    ...
    for(uint pi = 0; pi < raysPerPixel.x; pi++)
    {
        for(uint pj = 0; pj < raysPerPixel.y; pj++)
        {
            ...
            if(a.x != 0.0)
            {
                sidonIncrement.x = voxelSizes.x / a.x;
            ...
            if(a.y != 0.0)
            {
                sidonIncrement.y = voxelSizes.y / a.y;
            ...
            if(a.z != 0.0)
            {
                sidonIncrement.z = voxelSizes.z / a.z;
